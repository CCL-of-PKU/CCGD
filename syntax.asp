...
FormInfo(2) = Array("as_subject_sample", "", "text", "", "", "")
FormInfo(3) = Array("as_predicate", "是否做谓语", "select", "", "yesno", "")
FormInfo(4) = Array("as_predicate_sample", "", "text", "", "", "")
FormInfo(5) = Array("as_object", "是否做宾语", "select", "", "yesno", "")
FormInfo(6) = Array("as_object_sample", "", "text", "", "", "")
FormInfo(7) = Array("as_attribute", "是否做定语", "select", "", "yesnode1", "")
FormInfo(8) = Array("as_attribute_sample", "", "text", "", "", "")
FormInfo(9) = Array("as_adverbial", "是否做状语", "select", "", "yesnode2", "")
FormInfo(10) = Array("as_adverbial_sample", "", "text", "", "", "")
FormInfo(11) = Array("as_complement", "是否做补语", "select", "", "yesnode3", "")
FormInfo(12) = Array("as_complement_sample", "", "text", "", "", "")
FormInfo(13) = Array("as_preposition", "是否做介宾", "select", "", "yesno", "")
FormInfo(14) = Array("as_preposition_sample", "", "text", "", "", "")
FormInfo(15) = Array("with_object", "是否带宾语", "select", "", "yesno", "")
FormInfo(16) = Array("with_object_sample", "", "text", "", "", "")
FormInfo(17) = Array("with_complement", "是否带补语", "select", "", "yesnode3", "")
FormInfo(18) = Array("with_complement_sample", "", "text", "", "", "")
FormInfo(19) = Array("with_de1", "是否带“的”", "select", "", "yesno", "")
FormInfo(20) = Array("with_de1_sample", "", "text", "", "", "")
FormInfo(21) = Array("with_de2", "是否带“地”", "select", "", "yesno", "")
FormInfo(22) = Array("with_de2_sample", "", "text", "", "", "")
FormInfo(23) = Array("joint_preceding", "联合结构前项", "select", "", "yesno", "")
FormInfo(24) = Array("joint_preceding_sample", "", "text", "", "", "")
FormInfo(25) = Array("joint_consequent", "联合结构后项", "select", "", "yesno", "")
FormInfo(26) = Array("joint_consequent_sample", "", "text", "", "", "")
FormInfo(27) = Array("lianwei_preceding", "连谓结构前项", "select", "", "yesno", "")
FormInfo(28) = Array("lianwei_preceding_sample", "", "text", "", "", "")
FormInfo(29) = Array("lianwei_consequent", "连谓结构后项", "select", "", "yesno", "")
FormInfo(30) = Array("lianwei_consequent_sample", "", "text", "", "", "")
FormInfo(31) = Array("be_sentence", "是否独立成句", "select", "", "yesno", "")
FormInfo(32) = Array("be_sentence_sample", "", "text", "", "", "")
FormInfo(33) = Array("bound", "是否能自由使用", "select", "", "yesno", "")
FormInfo(34) = Array("bound_sample", "", "text", "", "", "")
