...
sub doSearch
	...
	sql = "SELECT DISTINCT construction.ID as ID, construction.form as form,construction.feature as feature,example,variables,constants " &_
		...
		"LEFT JOIN reference ON construction.ID = reference.construction_id) WHERE construction.ID>0 "
